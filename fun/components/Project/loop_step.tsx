...
export default function Step_Loop(prop : StepPropsAttr){
    ...
    return (
        <div id={`Lv${Step.step_id}`}>
            ...
            {
                Step.step_image? 
                <Image style={{height:"400px"}} src={Step.step_image} alt={Step.step_name} width={500} height={500} className="h-[400px] mt-3 2xs:my-2 rounded-lg shadow-lg w-[95%] xs:mt-2 lg:mt-0 md:mt-0"></Image>
                : <></>
            }
            </div>
        </div>
